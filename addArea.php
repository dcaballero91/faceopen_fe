...
<body>
	...
	<div class="container">
		<div class="content">
			<h2>Datos del Area &raquo; Agregar datos</h2>
			<hr />
			...
			if(isset($_POST['add'])){
				...
				$cek = mysqli_query($con, "SELECT * FROM area WHERE area_cod='$area_cod'");
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($con, "INSERT INTO area(area_desc,area_cod)
															VALUES('$area_desc','$area_cod')") or die(mysqli_error());
						if($insert){
			...
			<form class="form-horizontal" action="" method="post">
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" name="area_desc" class="form-control" placeholder="TIC" required>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label">Código Área</label>
					<div class="col-sm-2">
						<input type="text" name="area_cod" class="form-control" placeholder="666" required>
					</div>
				</div>
				<div class="form-group">
