	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['save'])){
				...
				$update = mysqli_query($con, "UPDATE roles SET rol_desc='$rol_desc',rol_mail='$rol_mail' WHERE id_rol='$id_rol'") or die(mysqli_error());
				if($update){
			...
			<form class="form-horizontal" action="" method="post">
				...
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="email" name="rol_mail" value="<?php echo $row ['rol_mail']; ?>" class="form-control" placeholder="juanperez@gmail.com" required>
					</div>
				</div>
				<div class="form-group">
